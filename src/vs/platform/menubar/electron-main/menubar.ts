...
import { IWindowOpenable, hasNativeTitlebar, INativeRunActionInWindowRequest, INativeRunKeybindingInWindowRequest } from '../../window/common/window.js';
	...
	private createOpenRecentMenuItem(item: IMenubarMenuRecentItemAction): MenuItem {
		...
		return new MenuItem(this.likeAction(commandId, {
			...
			click: async (menuItem, win, event) => {
				...
				const success = windows.length > 0;
