	...
	public createExtensionHost(runningLocations: ExtensionRunningLocationTracker, runningLocation: ExtensionRunningLocation, isInitialStart: boolean): IExtensionHost | null {
		switch (runningLocation.kind) {
			case ExtensionHostKind.LocalProcess: {
				...
				return this._instantiationService.createInstance(new SyncDescriptor(NativeLocalProcessExtensionHost, [runningLocation, startup, this._createLocalProcessExtensionHostDataProvider(runningLocations, isInitialStart, runningLocation)], true));
			}
			case ExtensionHostKind.LocalWebWorker: {
				if (this._webWorkerExtHostEnablement !== LocalWebWorkerExtHostEnablement.Disabled) {
					...
					return this._instantiationService.createInstance(new SyncDescriptor(WebWorkerExtensionHost, [runningLocation, startup, this._createWebWorkerExtensionHostDataProvider(runningLocations, runningLocation)], true));
				}
				return null;
			}
			case ExtensionHostKind.Remote: {
				...
				if (remoteAgentConnection) {
					return this._instantiationService.createInstance(new SyncDescriptor(RemoteExtensionHost, [runningLocation, this._createRemoteExtensionHostDataProvider(runningLocations, remoteAgentConnection.remoteAuthority)], true));
				}
				return null;
			}
		}
